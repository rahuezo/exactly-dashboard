from deltas import get_delta_percent, delta_to_color
...
DB_STATS_MODULE_TEMPLATES = [PROFILES_MODULE, LOCATIONS_MODULE, EMAILS_MODULE, SE_MODULE, CORPORATIONS_MODULE, TECH_MODULE, WEBSITES_MODULE, APPENDED_MODULE, CAMPAIGN_MODULE]